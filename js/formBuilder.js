...
function askForKey(keyDeleted) {
    ...
    form_html += '<label for="key_no"><b>No</b> I do not have a unique key question for this form, please generate one for me</label>';
    form_html += '<input type="radio" value="no" id="key_no" name="key" data-value="no" checked="checked">';
    form_html += '<label for="key_yes"><b>Yes</b> I have a unique key question for this form.</label>';
