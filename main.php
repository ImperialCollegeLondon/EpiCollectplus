...
include(sprintf('%s/utils/validate.php', $DIR));
include(sprintf('%s/utils/entryHandler.php', $DIR));
include(sprintf('%s/utils/formHandler.php', $DIR));
include(sprintf('%s/utils/dataHandler.php', $DIR));
include(sprintf('%s/utils/media.php', $DIR));
include(sprintf('%s/utils/ui/applyTemplate.php', $DIR));
include(sprintf('%s/utils/ui/siteHome.php', $DIR));
include(sprintf('%s/utils/ui/listMyProjects.php', $DIR));
include(sprintf('%s/utils/login/login.php', $DIR));
include(sprintf('%s/utils/project/project.php', $DIR));
include(sprintf('%s/utils/project/uploadProjectXML.php', $DIR));
include(sprintf('%s/utils/project/handleXML.php', $DIR));
include(sprintf('%s/utils/config/sitetest.php', $DIR));
include(sprintf('%s/utils/map/markers.php', $DIR));
include(sprintf('%s/utils/user/updateUser.php', $DIR));
include(sprintf('%s/utils/user/createAccount.php', $DIR));
include(sprintf('%s/utils/user/createUser.php', $DIR));
include(sprintf('%s/utils/user/saveUser.php', $DIR));
include(sprintf('%s/utils/user/userHandler.php', $DIR));
include(sprintf('%s/utils/user/admin.php', $DIR));
include(sprintf('%s/utils/user/listUsers.php', $DIR));
include(sprintf('%s/utils/user/toggleUser.php', $DIR));
include(sprintf('%s/utils/user/managerHandler.php', $DIR));
include(sprintf('%s/utils/user/resetPassword.php', $DIR));
